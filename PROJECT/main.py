...
db=SQLAlchemy(app)
# here we will create db models(database table) that is tables
class Test(db.Model):
...
def patient():
    ...
    if request.method=="POST":
        ...
        # mail.send_message('HOSPITAL MANAGEMENT SYSTEM', sender='ka587183@gmail.com', recipients=[email],body=f"YOUR BOOKING IS CONFIRMED THANKS FOR CHOOSING US \nYour Entered Details are :\nName: {name}\nSlot: {slot}")
